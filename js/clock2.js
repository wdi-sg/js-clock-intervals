...
var milSeconds = document.getElementById('milSeconds');
...
function translateMilSec() {
	...
	if (milSec > 99) {
		milSeconds.innerHTML = milSec.toString();
	} else if (milSec > 9) {
		milSeconds.innerHTML = '0' + milSec.toString();
	} else {
		milSeconds.innerHTML = '00' + milSec.toString();
	}
}
